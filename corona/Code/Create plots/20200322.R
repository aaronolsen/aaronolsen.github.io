...
run <- function(){
	...
	labels_out <- list(
		'AK'=c(0,0.5,0.5,-0.5),	# Upper right
		'CA'=c(0.5,0,0,0.5),			# Right
		'CO'=c(1,0,-0.2,0.5),
		'CT'=c(-1.2,0,1,0.5),
		'FL'=c(0.8,0,-0.1,0.5),
		'GA'=c(0.3,-2,-0.2,0.5),		# Upper left
		#'GU'=c(-0.7,2,1,0),		# Upper left
		'ID'=c(0.7,-0.7,-0.2,0.7),	# Lower right
		'IN'=c(0.3,0,-0.2,0.5),	# Lower right
		'MS'=c(0,4,0.5,-0.5),			# Upper
		'MT'=c(-1.2,0,1,0.5),
		'NC'=c(-0.7,0,1,0.5),		# Left
		'NV'=c(1,0,-0.2,0.5),		# Right\
		'RI'=c(1.2,0,-0.1,0.5),
		'SC'=c(-0.3,-3,1,0.5),	# Lower left
		#'OK'=c(0.2,0,-0.2,0.5),
		'UT'=c(0,-1,0.5,1),		# Upper left
		'VA'=c(0.5,-1.7,-0.2,1.2),
		#'WI'=c(1.2,0,0.1,0.5),
		'WY'=c(1.2,0,0.1,0.5)			# Left
	)
