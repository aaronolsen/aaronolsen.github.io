...
run <- function(){
	...
	mar_rank <- c(3,9)		# Number of states to include at slowest and fastest of ranking
...
#		'intercept'=rownames(log_sfp_lm_mat_nna)[order(log_sfp_lm_mat_nna[, 'intercept'])],
	...
	text(x=0.41, y=1.4, labels=toupper('Higher testing rate\nLower % positive'), col=bg_txt_col, cex=bg_text_cex)
